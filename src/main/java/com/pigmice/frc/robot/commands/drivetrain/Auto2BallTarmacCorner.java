...
public class Auto2BallTarmacCorner extends SequentialCommandGroup {

        private static final double DISTANCE_TO_BALL_METERS = 2.0;

        public Auto2BallTarmacCorner(Indexer indexer, Shooter shooter, Intake intake, Drivetrain drivetrain) {
                ...
                this.setName("[5] Two Ball Tarmac Corner");
        }
}
